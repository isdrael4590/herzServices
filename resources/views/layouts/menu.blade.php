...
@can ('access_calendarmtto')
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('calendarmttos.*') || request()->routeIs('calendarmtto-categories.*') ? 'c-show' : '' }}">
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        <i class="c-sidebar-nav-icon bi bi-people" style="line-height: 1;"></i> Gestión Calendario.
    </a>
    <ul class="c-sidebar-nav-dropdown-items">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('calendarmttos.index') ? 'c-active' : '' }}"
                href="{{ route('calendarmttos.index') }}">
                <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i>  Ver Calendario
            </a>
        </li>
        @can('create')
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('calendarmttos.create') ? 'c-active' : '' }}"
                    href="{{ route('calendarmttos.create') }}">
                    <i class="c-sidebar-nav-icon bi bi-person-plus" style="line-height: 1;"></i> Ver Calendario
                </a>
            </li>
        @endcan
...
@can ('access_maintenance_asset')
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('asset.*') || request()->routeIs('calendarmtto-categories.*') ? 'c-show' : '' }}">
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        <i class="c-sidebar-nav-icon bi bi-people" style="line-height: 1;"></i> Gestión CMMS.
    </a>
    <ul class="c-sidebar-nav-dropdown-items">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('asset.index') ? 'c-active' : '' }}"
                href="{{ route('asset.index') }}">
                <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i>  Ver Agenda
            </a>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('workorder.index') ? 'c-active' : '' }}"
                href="{{ route('workorder.index') }}">
                <i class="c-sidebar-nav-icon bi bi-journals" style="line-height: 1;"></i>  Ver Ordenes de trabajo
            </a>
        </li>
...
<br>
<br>
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('machines.*') || request()->routeIs('machine-categories.*') ? 'c-show' : '' }}">
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
